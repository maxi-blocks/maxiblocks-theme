document.addEventListener('DOMContentLoaded', function () {
    function checkAndReplaceIframe() {
        const button = document.getElementById(
            'edit-site-patterns-maxiblocks-pure-footer-dark-pfd-pro-105-copy-copy'
        );
        ...
        if (button) {
            ...
            if (iframe) {
                ...
                img.src =
                    '/wp-content/themes/maxiblocks/maxi-patterns/custom-footer/custom-footer-preview.jpg';
                ...
                try {
                    ...
                    console.error('Error replacing iframe with image:', error);
